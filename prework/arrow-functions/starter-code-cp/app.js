...
//TL;DR
/*
1-Arrow functions can never have duplicate named parameters, whether in strict or non-strict mode.
...
3-Arrow functions can never be used as constructor functions. Hence, they can never be invoked with the new keyword. As such, a prototype property does not exist for an arrow function.
4-The value of this inside an arrow function remains the same throughout the lifecycle of the function and is always bound to the value of this in the closest non-arrow parent function.
*/
...
// TODO: After viewing the previous console.log(), return the code to a working state.
/*
trying to call by arrow function cannot ^^
...
//Student {name: "Joe", age: "Schmoe", hometown: 100}(student object), undefined
// 2. What is "this" when joe.scopeArrow() is invoked?
//Window {window: Window, self: Window, document: document, name: "", location: Location, …}(wiondow object), undefined
