...
// TODO: Uncomment the following line of code to see the output in the browser console
console.log('The old way:', theNewWay('Code 301'));
...
let nSum = (a,b,c,d) => `${a+b+c+d}`;
console.log(`arrowsum=${nSum(1, 2, 3, 4)}`)
// TODO: Uncomment the following line of code to see the output in the browser console
...
let nMessage = name => `Hello, ${name}!`
console.log(`arrowmessag = ${nMessage('Allie')}`);
