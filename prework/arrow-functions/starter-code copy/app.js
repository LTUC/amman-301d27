...
//globle window object
// 3. Explain why "this" is different when an arrow function is used.
//because the this keyword is bound to different values based on the context in which the function is called. and does not have its own bindings to this or super, and should not be used as methods.
